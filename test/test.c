...
main(void)
{
...

    {
        ...
        actual_split_pattern_list = str8_split_pattern(arena, input, split);
        actual_split_pattern_array = str8_array_from_list(arena, &actual_split_pattern_list);
        Assert(str8_array_equal(expected_split_pattern_array, actual_split_pattern_array));
        printf("passed\n");

        printf("str8_split_substr ... ");
        actual_split_substr_list = str8_split_substr(arena, input, split);
        actual_split_substr_array = str8_array_from_list(arena, &actual_split_substr_list);
...

    {
        ...
        printf("str8_from_16 ... ");
        actual_utf8 = str8_from_16(arena, expected_utf16);
        Assert(str8_equal(expected_utf8, actual_utf8));
        printf("passed\n");

        printf("str16_from_8 ... ");
        actual_utf16 = str16_from_8(arena, expected_utf8);
        Assert(str16_equal(expected_utf16, actual_utf16));
        printf("passed\n");

        printf("str8_from_32 ... ");
        actual_utf8 = str8_from_32(arena, expected_utf32);
        Assert(str8_equal(expected_utf8, actual_utf8));
        printf("passed\n");

        printf("str32_from_8 ... ");
        actual_utf32 = str32_from_8(arena, expected_utf8);
